...
class viewpageradapter(private val context: Context,private val entryList:ArrayList<movies>) :
    RecyclerView.Adapter<viewpageradapter.NoteViewHolder>() {
    ...
    inner class NoteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val thirdimage:ImageView=itemView.findViewById(R.id.imageView2)
    }
}
